	...
	return (
		<article className={styles.policyInfo}>
			...
			<p>
				...
				конфиденциальности) действует в отношении всей информации, которую Общество с ограниченной
				ответственностью «Внедорожники и Пикапы», далее «Интернет-магазин», расположенный на
				доменном имени {process.env.DOMEN || "https://kitkars.ru"} может получить о Пользователе во
				...
				<li>
					...
					<ul>
						...
						<li>
							...
							способом с Название интернет-магазина.
						</li>
						<li>
				...
				<li>
					...
					<ul>
						...
						<li>
							...
							Пользователя, оформленного на Сайте интернет-магазина « Название магазина», включая
							доставку Товара.
						</li>
						<li>
				...
				<li>
					...
					<ul>
						...
						<li>
							...
							сообщать указать раздел сайта интернет-магазина
						</li>
						<li>
							9.4. Действующая Политика конфиденциальности размещена на странице по адресу{" "}
							{process.env.DOMEN || "https://kitkars.ru" + "/policy"}
						</li>
					</ul>
				</li>
			</ol>
